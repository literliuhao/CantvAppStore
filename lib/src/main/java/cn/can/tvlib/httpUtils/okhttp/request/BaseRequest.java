package cn.can.tvlib.httpUtils.okhttp.request;
...
import cn.can.tvlib.httpUtils.okhttp.callback.AbsCallback;
...
public abstract class BaseRequest<R extends BaseRequest> {
    ...
    protected Request.Builder appendHeaders(Request.Builder requestBuilder) {
        ...
        ConcurrentMap<String, String> headerMap = headers.headersMap;
