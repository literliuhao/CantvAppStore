...
public class BlurDialogEngine {
    ...
    public void setAttachedToView(Activity holdingActivity) {
        mHoldingActivity = holdingActivity;
    }
    /**
     * Resume the engine.
    ...
    private void blur(Bitmap bkg, View view) {
        ...
        if (mDebudEnable) {
            ...
            Log.d(TAG, "DownScaleFactor : " + mDownScaleFactor);
            Log.d(TAG, "Blurred time : " + blurTime);
            Log.d(TAG, "Allocation : " + bkg.getRowBytes() + "k (screen capture) + "
                    + overlay.getRowBytes() + "k (FastBlur)");
