...
public class GlideRoundCornerImageView2 extends RelativeLayout {

    private RoundCornerImageView2 mBackgroundView;
    private RoundCornerImageView2 mImageView;

    private int mBgResId;
    private int mLoadingResId;
    private int mImageResId;

    public GlideRoundCornerImageView2(Context context, AttributeSet attrs) {
        super(context, attrs);

        int bgResId = 0;
        int loadingResId = 0;
        int imageResId = 0;
        int cornerRadius = RoundCornerImageView2.DEF_CORNER_RADIUS;
        int maskColor = 0;
        int maskSize = 0;

        if (attrs != null) {
            TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.GlideRoundCornerImageView2);
            bgResId = typedArray.getResourceId(R.styleable.GlideRoundCornerImageView2_background_res, 0);
            loadingResId = typedArray.getResourceId(R.styleable.GlideRoundCornerImageView2_loading_res, 0);
        ...
        mBackgroundView = new RoundCornerImageView2(context);
        ...
        mImageView = new RoundCornerImageView2(context, attrs);
