...
public class RoundCornerImageView2 extends ImageView {
    ...
    public RoundCornerImageView2(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.RoundCornerView2);
        cornerRadius = typedArray.getDimensionPixelSize(R.styleable.RoundCornerView2_cornerSize2, cornerRadius);
        mMaskColor = typedArray.getColor(R.styleable.RoundCornerView2_maskColor, 0);
        mMaskSize = typedArray.getDimensionPixelSize(R.styleable.RoundCornerView2_maskSize, 0);
        typedArray.recycle();
