...
public class DownloadAdapter extends CanRecyclerViewAdapter<DownloadTask> {
    ...
    protected RecyclerView.ViewHolder generateViewHolder(ViewGroup parent, int viewType) {
        ...
        holder.appContentLayout.setOnFocusChangeListener(holder.eventListener);
        holder.appControlBtn.setOnFocusChangeListener(holder.eventListener);
        holder.appDeleteBtn.setOnFocusChangeListener(holder.eventListener);
        holder.appDeleteBtn.setOnClickListener(holder.eventListener);
        holder.appControlBtn.setOnClickListener(holder.eventListener);
        holder.appContentLayout.setOnClickListener(holder.eventListener);
        holder.appContentLayout.setOnKeyListener(holder.eventListener);
        return holder;
    }
